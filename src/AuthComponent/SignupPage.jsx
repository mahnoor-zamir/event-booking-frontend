...
//                         <h1 className="text-3xl font-bold text-[#1e3a8a]">Welcome to EventHub</h1>
//                         <p className="text-[#64748b]">Your one-stop destination for event management</p>
//                     </div>
//                 </div>
...
//                     <CardHeader>
//                         <CardTitle className="text-2xl text-[#1e3a8a] text-center">Create Account</CardTitle>
//                     </CardHeader>
//                     <CardContent>
...
//                                     value={username}
//                                     onChange={(e) => setUsername(e.target.value)}
//                                     className="w-full p-2 border rounded-md focus:ring-2 focus:ring-[#1e3a8a] focus:border-transparent"
//                                     required
//                                 />
//                             </div>
//                             <div className="space-y-2">
...
//                             <Button 
//                                 type="submit" 
//                                 className="w-full bg-[#1e3a8a] hover:bg-[#1e3a8a]/90 text-white py-2 rounded-md"
//                                 disabled={isLoading}
//                             >
//                                 {isLoading ? (
...
//                             </Button>
//                         </form>
//                         <div className="mt-4 text-center text-[#64748b]">
